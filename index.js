...
var File = (function (_super) {
    ...
    File.prototype.readAsArrayBufferRange = /**
       * Read file and return data as an ArrayBuffer.
       * @param {string} path Base FileSystem. Please refer to the iOS and Android filesystem above
       * @param {string} file Name of file, relative to path.
       * @returns {Promise<ArrayBuffer>} Returns a Promise that resolves with the contents of the file as ArrayBuffer or rejects with an error.
       */
    function (path, file, start, end) {
        return this.readFileRange(path, file, 'ArrayBuffer', start, end);
    };
    ...
    File.prototype.readFileRange = function (path, file, readAs, start, end) {
        var _this = this;
        if (/^\//.test(file)) {
            var err = new FileError(5);
            err.message = 'file-name cannot start with /';
