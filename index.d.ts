...
export declare class FileReader {
    ...
    readAsArrayBufferRange(fe: IFile, start: number, end: number): void;
    /**
     * @hidden
     */
    [key: string]: any;
...
export declare class File extends IonicNativePlugin {
    ...
    readAsArrayBufferRange(path: string, file: string, start: number, end: number): Promise<ArrayBuffer>;
    private readFile<T>(path, file, readAs);
    private readFileRange<T>(path, file, readAs, start, end);
    /**
